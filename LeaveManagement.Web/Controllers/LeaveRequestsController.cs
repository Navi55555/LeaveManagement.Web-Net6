...
namespace LeaveManagement.Web.Controllers
{
    ...
    public class LeaveRequestsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StartDate,EndDate,LeaveTypeId,DateRequested,RequestComments,Approved,Cancelled,RequestinEmployeeId,Id,DateCreated,DateModified")] LeaveRequest leaveRequest)
        {
