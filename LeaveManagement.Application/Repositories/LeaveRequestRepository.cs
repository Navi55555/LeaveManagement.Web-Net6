...
namespace LeaveManagement.Application.Repositories
{
    public class LeaveRequestRepository : GenericRepository<LeaveRequest>, ILeaveRequestRepository
    {
        ...
        public async Task CancelLeaveRequest(int leaveRequestId)
        {
            ...
            var user = await userManager.FindByIdAsync(leaveRequest.RequestinEmployeeId);
        ...
        public async Task ChangeApprovalStatus(int leaveRequestId, bool approved)
        {
            ...
            if (approved)
            {
                var allocation = await leaveAllocationRepository.GetEmployeeAllocation(leaveRequest.RequestinEmployeeId, leaveRequest.LeaveTypeId);
        ...
        public async Task<bool> CreateLeaveRequest(LeaveRequestCreateVM model)
        {
            ...
            leaveRequest.RequestinEmployeeId = user.Id;
        ...
        public async Task<AdminLeaveRequestViewVM> GetAdminLeaveRequestList()
        {
            ...
            {
                leaveRequest.Employee = mapper.Map<EmployeeListVM>(await userManager.FindByIdAsync(leaveRequest.RequestinEmployeeId));
            }
        ...
        {
            return await context.LeaveRequests.Where(q => q.RequestinEmployeeId == employeeId)
        ...
        public async Task<LeaveRequestVM?> GetLeaveRequestAsync(int? id)
        {
            ...
            model.Employee = mapper.Map<EmployeeListVM>(await userManager.FindByIdAsync(leaveRequest?.RequestinEmployeeId));
            return model;
        }
